...
CREATE TABLE ANGAZOVANJE (
	...
	CONSTRAINT PK_ANGAZOVANJE
		PRIMARY KEY (Id_institucije, Id_istrazivaca),
...
CREATE TABLE AUTORSTVO (
	...
	CONSTRAINT PK_AUTORSTVO PRIMARY KEY (Id_publikacije, Id_autora),
...
CREATE TABLE POVEZAN_SA (
    ...
    CONSTRAINT PK_POVEZAN_SA
        PRIMARY KEY (Id_publikacije_1, Id_publikacije_2),
...
CREATE TABLE CITIRA (
    ...
    CONSTRAINT PK_CITIRA
        PRIMARY KEY (Id_publikacije, Id_citata),
    ...
    CONSTRAINT FK_CITIRA_CITAT
        FOREIGN KEY (Id_citata)
        REFERENCES PUBLIKACIJA(Id),

    CONSTRAINT CHK_CITIRA
        CHECK (Id_publikacije <> Id_citata)
);
...
CREATE TABLE VRSI_RECENZIJU (
    ...
    CONSTRAINT PK_VRSI_RECENZIJU
        PRIMARY KEY (Id_Runde_Recenzije, Id_recenzenta),
...
CREATE TABLE NIZ_OCENA (
    ...
    CONSTRAINT PK_NIZ_OCENA
        PRIMARY KEY (Broj_runde, Id_publikacije, Id_recenzenta, Kriterijum),

    CONSTRAINT FK_NIZ_OCENA_RECENZIJA
        FOREIGN KEY (Broj_runde, Id_publikacije, Id_recenzenta)
        REFERENCES VRSI_RECENZIJU(Broj_runde, Id_publikacije, Id_recenzenta),
