...
namespace DigitalniRepozitorijum.Forme
{
    public partial class PovezanePublikacijeForm : Form
    {
        ...
        {
            var id = GetSelectedId(); if (id == null) return; using var form = new IzmeniPovezanuPublikacijuForm(_idPublikacije);
            form.ShowDialog();
        }
        ...
        private void PovezanePublikacijeForm_Load(object sender, EventArgs e)
        {
            ...
            {
                dataGridView.Rows.Add(p.IdPublikacije2, p.Naslov, p.TipPovezanosti);
            }
