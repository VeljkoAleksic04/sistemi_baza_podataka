...
{
    public partial class KontaktMailoviInstitucijeForm : Form
    {
        private readonly int? _idInstitucije;

        public KontaktMailoviInstitucijeForm(int? idInstitucije = null)
        {
        ...
        public void PopuniPodacima()
        {
            ...
            List<InstitucijaKontaktMailPregled> podaci = DTOManager.vratiSveKontaktMailove(_idInstitucije.Value);

            foreach (var p in podaci)
                dataGridView.Rows.Add(p.Id, p.KontaktMail);
        ...
        {
            using var form = new DodajKontaktMailForm(_idInstitucije);
        ...
        private void btnIzmeni_Click(object sender, EventArgs e)
        {
            ...
            using var form = new IzmeniKontaktMailForm(_idInstitucije, id);
            if (form.ShowDialog() == DialogResult.OK)
                PopuniPodacima();
        }
